...
function ConflictReasonAndPlace() {
  return (
    <div>
      ...
      {createQuestion("conflict-reason", "3.1. Почему Вы конфликтуете?", [
        [
          "emotional-conflict",
          "Мне не нравится оппонент (его слова, поступки, отношение ко мне)",
        ],
        [
          "social-conflict",
          "Оппонент не совпадает со мной в едином видении наших дел",
        ],
        [
          "rational-conflict",
          "Все, что делает оппонент, разрушает наши с ним отношения",
        ],
      ])}

      {createQuestion("conflict-place", "3.2. Где Вы конфликтуете?", [
        ["work-conflict", "На работе"],
        ["family-conflict", "В семье"],
        ["friend-conflict", "В кругу знакомых / друзей"],
      ])}
