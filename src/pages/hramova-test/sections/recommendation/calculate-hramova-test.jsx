import showAlert from '../../../../functions/render-error';
...
function calculateHramovaTest(event) {
  ...
  if (emotionalConflict && workConflict) {
    recommendationText =
      'Для улаживания этого конфликта вам необходимо укротить свои эмоции и вспомнить об иерархии ' +
      'отношений на рабочем месте.';
  } else if (emotionalConflict && familyConflict) {
    recommendationText =
      'Выключите свои негативные эмоции в отношении оппонента и вспомните о ваших с ним ' +
      'совместных целях.';
  } else if (emotionalConflict && friendConflict) {
    recommendationText =
      'Эмоционально «вскипая» в общественном пространстве попробуй напомнить себе, что в ' +
    ...
    recommendationText =
      'Вы следите за своими эмоциями на работе. Осознаете диспозицию в организации. ' +
    ...
    recommendationText =
      'В осознаваемых вами совместных целях с партнером самым лучшим помощником вам ' +
      'станет его осознание этих целей. Обсуждайте с ним ваши совместные цели.';
  } else if (socialConflict && friendConflict) {
    recommendationText =
      'Если ты осознаешь диспозицию конфликта, свои интересы и интересы других, то укротив' +
    ...
    recommendationText =
      'Не контролируя свои эмоции, помните что вам важнее: истина или здоровые ' +
    ...
    recommendationText =
      'Выключив негативные эмоции в отношении партнера и прислушавшись к нему, вы ' +
    ...
    recommendationText =
      'Контролируя негативные эмоции и осознавая всю значимость для тебя того ' +
