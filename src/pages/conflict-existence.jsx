...
function ConflictExistence() {
    return (
        <div>
            ...
            { createQuestion(
                'conflict-type', 'Вводное понятие: Интерес – это Ваше действие для исполнения ' +
                'какого-то желания. В сложившейся ситуации Вы можете определить мешает ли кто-либо Вам ' +
